...
<!-- Script
============================================= -->
<script src="<?php echo $sysconf['template']['dir']; ?>/mdpus/js/jquery.min.js"></script>
...
<script src="<?php echo SWB; ?>template/mdpus/js/jquery.jcarousel.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/mdpus/js/jquery.transit.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/mdpus/js/bootstrap.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/mdpus/js/custom.js"></script>

<!-- Style Minified
============================================= 
<link rel="stylesheet" type="text/css" href="<?php echo SWB; ?>template/mdpus/style.css" />-->
<!-- Style Minified by mdpus
============================================= -->
<link rel="stylesheet" type="text/css" href="<?php echo SWB; ?>template/mdpus/css/style.css" />
...
============================================= -->
<!-- For Developmet Only
<link rel="stylesheet/less" type="text/css" href="<?php echo SWB; ?>template/mdpus/style.min.css"/>
<script>less = { env: "development" };</script>
<script src="<?php echo $sysconf['template']['dir']; ?>/mdpus/js/less.min.js"></script>
-->