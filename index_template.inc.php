 ...
 * Modified by I Made Pustikayasa (imdpus@gmail.com)
 * Slims 8 (Akasia)
 * 
...
<section  id="content" class="s-main-page" >
...
//About
include "partials/partner.php"; 
//contact info
//include "partials/contactinfo.php"; 
...
<script>
  ...
  $('.book img').error(function(){
    ...
    $(this).attr({
      src   : './template/mdpus/img/book.png',  
  ...
  $('.librarian-image img').error(function(){
    $(this).attr('src','./template/mdpus/img/avatar.jpg');
  });
